...
const DEFAULT_HOME_SECTIONS: HomeSectionConfig[] = [
  ...
  { type: "stories_bar", order: 2, enabled: true, moduleKey: "stories" },
  { type: "ad_slot_top", order: 3, enabled: true },
  { type: "hero_headlines", order: 4, enabled: true },
  { type: "live_broadcast", order: 5, enabled: true, moduleKey: "lives" },
  { type: "agora_na_cidade", order: 6, enabled: true },
  { type: "latest_news", order: 7, enabled: true },
  { type: "super_banner", order: 8, enabled: true },
