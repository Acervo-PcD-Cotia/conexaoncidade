        ...
        <CardContent>
          <div className="flex items-center gap-4">
            <div className="flex gap-2">
              ...
              <div className="h-10 w-10 rounded-lg bg-brand" title="Brand (Azul Petróleo)" />
              <div className="h-10 w-10 rounded-lg bg-ai" title="AI (Roxo)" />
              <div className="h-10 w-10 rounded-lg bg-money" title="Money (Verde)" />
            </div>
