...
export default function ConexaoAIDashboard() {
  ...
  const actionCards = [
    {
      ...
      icon: Newspaper,
      route: "/admin/conexao-ai/criador",
    ...
    },
    {
      ...
      icon: MessageSquare,
      route: "/admin/conexao-ai/assistente",
    ...
    },
    {
      ...
      icon: Store,
      route: "/admin/conexao-ai/ferramentas",
    ...
    },
    {
      ...
      icon: BarChart3,
      route: "/admin/conexao-ai/insights",
  ...
  const quickLinks = [
    ...
    },
    {
      ...
      icon: Zap,
      route: "/admin/conexao-ai/automacoes",
    },
  ];
