...
const modules: CoreModule[] = [
  { id: "seo", title: "SEO Profissional", description: "Meta tags, score SEO, sitemap, robots.txt, breadcrumb", icon: Search, status: "partial", statusLabel: "Parcial", url: "/spah/painel/core-engine/seo", color: "text-blue-500" },
  ...
  { id: "media", title: "Mídia Inteligente", description: "Compressão, WebP, hero/OG/card, ALT, duplicatas", icon: ImageIcon, status: "partial", statusLabel: "Parcial", url: "/spah/painel/core-engine/media", color: "text-pink-500" },
