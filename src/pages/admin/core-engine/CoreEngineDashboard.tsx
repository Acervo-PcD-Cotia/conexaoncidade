...
const modules: CoreModule[] = [
  ...
  { id: "performance", title: "Performance", description: "Core Web Vitals, LCP, CLS, TTFB, alertas, imagens não otimizadas", icon: Zap, status: "active", statusLabel: "Ativo", url: "/spah/painel/core-engine/performance", color: "text-yellow-500" },
  { id: "security", title: "Segurança", description: "Firewall, brute force, 2FA, logs, bloqueio IP", icon: Shield, status: "active", statusLabel: "Ativo", url: "/spah/painel/core-engine/security", color: "text-red-500" },
  { id: "analytics", title: "Analytics Interno", description: "Tempo real, visitas, origem, dispositivo, integrações GA4/Meta", icon: BarChart3, status: "active", statusLabel: "Ativo", url: "/spah/painel/core-engine/analytics", color: "text-purple-500" },
  ...
  { id: "leads", title: "Captação de Leads", description: "Formulários, segmentação, funil, export CSV, gestão completa", icon: Users, status: "active", statusLabel: "Ativo", url: "/spah/painel/core-engine/leads", color: "text-teal-500" },
  { id: "redirect", title: "Redirecionamento", description: "301, 302, monitor 404, sugestões automáticas", icon: ArrowRightLeft, status: "active", statusLabel: "Ativo", url: "/spah/painel/core-engine/redirect", color: "text-amber-500" },
  { id: "schema", title: "Schema & Dados", description: "Article, NewsArticle, FAQ, LocalBusiness, Breadcrumb, validador", icon: Code2, status: "active", statusLabel: "Ativo", url: "/spah/painel/core-engine/schema", color: "text-cyan-500" },
